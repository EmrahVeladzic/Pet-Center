...
namespace PetCenterServices.Interfaces
{
    ...
    {        
        public Task <ServiceOutput<ReportResponseSubDTO>> ReportMisuse(Guid token_holder, Guid ListingId, Guid? CommentId, string Reason, Access authorization_level);
        ...
        public Task <ServiceOutput<object>> Evaluate (Guid token_holder, Guid ListingId,bool approved,string note);
