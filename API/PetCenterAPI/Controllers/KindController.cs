...
namespace PetCenterAPI.Controllers
{
    ...
    public class KindController : ControllerTemplate<Kind,KindSearchObject,KindDTO,KindDTO,IKindService>
    {
        ...
        [HttpPut("{id}")]
        public override Task<IActionResult> Put([FromRoute] Guid id, [FromBody] KindDTO ent, [UserId] Guid user_id, [SessionId] Guid session)
        {
        ...
        [Authorize(Roles = "Admin,Owner")]
        [HttpPost]
        public override Task<IActionResult> Post([FromBody] KindDTO ent, [UserId] Guid user_id, [SessionId] Guid session)
        {
